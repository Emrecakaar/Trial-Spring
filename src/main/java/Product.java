...
//ManyToOne larda cascadeType Remove demek yanlış çünkü birden çok ürün kategoriye ait olabilir
    ...
    //ManyToMany de Persist kullanmak mantıklı o producta ait veriler silindiğinde ona ait ilişkileri silmek mantıklı.
    @JoinTable(
            name = "pro2colors",
